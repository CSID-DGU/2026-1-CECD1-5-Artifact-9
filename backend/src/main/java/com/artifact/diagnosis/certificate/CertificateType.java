 ...
 * 발급 가능한 제증명 종류.
 *
 * <p>병원에서 떼주는 서류는 크게 <b>법정서식</b>과 <b>비법정서식</b>으로 나뉜다.
 ...
 *
 * <p>{@link #doctorOnly} 는 "누가 발급 버튼을 누를 수 있는가"다. 진단명이 들어가는 서류는
 * 의료법 제17조에 따라 <b>직접 진찰한 의사</b>만 낼 수 있다. 반면 진료확인서처럼 진단명 없이
 * "언제 왔다 갔다"만 확인해주는 서류는 실제 병원에서도 원무과가 발급한다.
 *
 * <p>{@link #aiFields} 는 LLM에게 초안을 맡길 <b>서술형 칸</b>의 이름이다. 병명·KCD코드·약품명·
